...
const api: DocVaultApi = {
  ...
  listVersions: (idOrPath) => ipcRenderer.invoke(CH.listVersions, idOrPath),
  readVersion: (docId, versionId) => ipcRenderer.invoke(CH.readVersion, docId, versionId),
  saveVersion: (idOrPath) => ipcRenderer.invoke(CH.saveVersion, idOrPath),
  restoreVersion: (docId, versionId) => ipcRenderer.invoke(CH.restoreVersion, docId, versionId),
  ...
  relatedDocs: (id, limit) => ipcRenderer.invoke(CH.relatedDocs, id, limit),
  embeddingStatus: () => ipcRenderer.invoke(CH.embeddingStatus),
  backfillEmbeddings: () => ipcRenderer.invoke(CH.backfillEmbeddings),
